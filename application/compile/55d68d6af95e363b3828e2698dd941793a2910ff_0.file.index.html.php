...
b1.jpg" alt="" style="width: 100%;height: 760px; position: absolute;">
            ...
            <div class="item-text0">
                <div class="item-text01">
                    <img src="<?php echo IMG_ADD;?>
border1.png" alt="" class="text01-img1">
                    <div class="item-text02">如何创建一个企业网站</div>
                    <img src="<?php echo IMG_ADD;?>
border1.png" alt=""
                         style="width: 37px;height: 10px;margin-left: 15px;float: left;margin-top: 7px;"
                         class="text01-img2">
                </div>
    ...
    <div class="service-con">
        ...
        <div class="service-row">
            <div class="service-icon">
                <img src="<?php echo IMG_ADD;?>
s1.png" alt="" style="margin-left:11px;">
            </div>
...
s2.png" alt="">
        ...
        <div class="service-row2">
            <div class="service-icon">
                <img src="<?php echo IMG_ADD;?>
s3.png" alt="" style="margin-left:11px;">
            </div>
            <div class="service-info">
                <span>自定义度大</span>
...
s4.png" alt="">
        ...
        <div class="service-row4">
            <div class="service-icon">
                <img src="<?php echo IMG_ADD;?>
s5.png" alt="" style="margin-left:11px;">
            </div>
            <div class="service-info">
                <span>搜索引擎优化</span>
...
s6.png" alt="">
        ...
        <div class="service-row6">
            <div class="service-icon">
                <img src="<?php echo IMG_ADD;?>
s7.png" alt="" style="margin-left:11px;">
            </div>
            <div class="service-info">
                <span>免费</span>

<?php
/* Smarty version 3.1.34-dev-7, created on 2020-08-30 16:26:24
  from 'D:\WampServer\www\2006\MVC\application\template\index\help.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f4bd33009b1c2_03644216',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fcb0aee1eafa86af033a41d6ebd7dfd5533a7c6f' => 
    array (
      0 => 'D:\\WampServer\\www\\2006\\MVC\\application\\template\\index\\help.html',
      1 => 1598804782,
      2 => 'file',
    ),
  ),
...
function content_5f4bd33009b1c2_03644216 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
help.png" alt="">
    ...
    <ol>
        <li style="padding: 0;text-align: right;">
            <div class="current" style="background: #F5F5F5;color:#333;border-top: none;text-shadow: none;">文档封面
            </div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div class="current">企业门户网介绍</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div class="current">快速上手</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div class="current">如何设置网站信息</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div class="current">如何设置自定义顶级域名</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div href="" class="current">如何做好网站管理</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div href="" class="current">如何管理好网站图库</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div href="" class="current">如何管理好站点文章</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div href="" class="current">如何管理好账户信息</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div href="" class="current">了解并使用vip特权</div>
        </li>
        <li style="padding: 0;text-align: right;">
            <div href="" class="current" style="border-bottom-color: #143D6B;">小技巧</div>
        </li>
    </ol>
    <div class="order">
                    ...
                    <li style="list-style: square;">选择导航对应的页面类型，导航页面类型决定了导航对应的是简单的一篇文章，一个文字列表页，还是一个图文列表。
                        <div class="erji" style="border-left-color: #1b809e;">
                            ...
                            <p style="margin-bottom: 0;">
                                导航“关于我们”一般会被设置为“文章页面”；导航“最近新闻”会被设置为“文字列表页”；导航“产品展示”会被设置为“图文列表页”。</p>
                        </div>
                    </li>
                    <li style="list-style: square;">
                        信息填写完成后，点击按钮“确认创建此导航”，导航即可创建成功，在这里，我们创建了一个“文字列表页”，名称为“问题与解答”，列表项文章的标题一般为问题，内容则为解答的内容：<br>
                        <img src="<?php echo IMG_ADD;?>
eight.png" alt="">
                    </li>
            ...
            <li style="list-style: decimal;margin-left: 36px;font-weight:normal;font-size:14px">
                ...
                <ul>
                    ...
                    <li style="list-style: square;">
                        删除导航：点击操作列的红色“X”按钮，在删除确认对话框中，点击确认删除即可进行删除；如果导航已经有对应的文章，则必须删除文章后才能进行删除</li>
...
>
    ...
    window.onscroll = function(){
        ...
        for (var i = 0; i < sn.length; i++) {
            if (sn[i].top < st && sn[i].top + sn[i].height > st) {
                for (var j = 0; j < sn.length; j++) {
                    sn[j].style.background = "#395E88"
                    sn[j].style.color = "#fff"
                }
                sn[i].style.background = "#F5F5F5";
                sn[i].style.color = "#333"
                sn[i].style.textShadow = "none"
            }
        }
    }
